...
const productos = [{id:'01', price:'$500', category:'Aros', name:'Argolla Plateada', 
                description:"Argolla de acero quirurgico", 
                img:'https://i.postimg.cc/rsyWp2gq/argolla-Plateada.jpg', stock:5},
                {id:'02', price:'$550', categoria:'Aros', name:'Aros', description:"Aros de acero quirurgico a presion", img:'https://i.postimg.cc/KvHLmVTy/aros.jpg', stock:15},
                {id:'04',price:'$600', category:'Aros', name:'Argollas Doradas', description:"Argolla de acero quirurgico dorado", img:'https://i.postimg.cc/SxY9RrLY/aros-Dorados.jpg', stock:7},
...
const ItemDetailContainer =()=>{
    ...
    useEffect(()=>{
        ...
        getData.then(res => setData(res.find(Accesorios => Accesorios.id === detalleId )))
    },[detalleId]);
